...
export const getSteps = (familyMember: FamilyMember): Step[] => [
  ...
  { id: 7, text: "Please provide details about their diabetes:", field: 'diabetesDetails', showIf: () => familyMember.hasDiabetes === true },
  { id: 8, text: "Have they had heart disease?", field: 'hasHeartDisease', isYesNo: true },
  { id: 9, text: "Please provide details about heart disease:", field: 'heartDiseaseDetails', showIf: () => familyMember.hasHeartDisease === true },
  { id: 10, text: "Have they had cancer?", field: 'hasCancer', isYesNo: true },
  { id: 11, text: "Please provide details about cancer:", field: 'cancerDetails', showIf: () => familyMember.hasCancer === true },
